...
class OrmQueryConfig {
  constructor(options = {}) {
    ...
    this.strategy = resolveOption('strategy', options.strategy, strategies, () => new OrmQueryStrategy(), options.strategyOptions);
...
function resolveOption(type, value, availableFactories, defaultFactory, ...defaultFactoryArgs) {
